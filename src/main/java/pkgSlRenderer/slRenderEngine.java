...
public class slRenderEngine {
    ...
    public void render() {
        ...
        updateRandVertices(); // Updates random color
        ...
        while (!my_wm.isGlfwWindowClosed()) {
            ...
            for (int i = 0; i < MAX_CIRCLES; i++) {
                ...
                // Generates circle (CENTER)
                generateCircleSegmentVertices(C_RADIUS, new float[]{0.0f, 0.0f}, begin_angle, end_angle, TRIANGLES_PER_CIRCLE);
            }
            glEnd();
            my_wm.swapBuffers();
        }
