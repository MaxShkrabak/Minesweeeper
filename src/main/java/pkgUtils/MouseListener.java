...
public class MouseListener {
    ...
    public static void mouseButtonCallback(long my_window, int button, int action,
                                           int mods) {
    ...
    public static void mouseScrollCallback(long my_window, double xOffset, double
            yOffset) {
        get().scrollX = xOffset;
        get().scrollY = yOffset;
    }
